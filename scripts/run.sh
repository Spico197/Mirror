...
single() {
    ...
    rex train -m src.task -dc conf/mirror-multi-task-pretrain.yaml -c conf/merge_uie_data.yaml -a train_filepath=/data/resources/Mirror/uie/merged/train_wo_overlap_v2.jsonl base_model_path=mirror_outputs/MirrorLarge_SamplingPretrain_woOverlap/ckpt/SchemaGuidedInstructBertModel.best.pth task_name=Mirror_UIE_wPT_woOverlapV2

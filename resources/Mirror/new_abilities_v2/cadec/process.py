...
def convert(raw_data: list, data_type: str):
    ...
    new_data = []
    instructions = [
        "Please extract discontinuous entities from the given types.",
        "Extract non-continuous entities from the provided categories.",
        "Identify and extract entities that are not continuous from the given types.",
        "Extract entities from the given categories that are not continuous.",
        "Separate the discontinuous entities from the provided types.",
        "Extract entities from the given types that are not contiguous.",
    ]

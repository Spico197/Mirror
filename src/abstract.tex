...
This graph structure is flexible, and it supports span-only machine reading comprehension, label-only classification, and label-span mixed information extraction tasks.
We manually construct a corpus containing 57 datasets for model pretraining, and experiments on 30 datasets across 8 tasks show that our model has good compatibilities and achieves SOTA performances under few-shot and zero-shot settings.
